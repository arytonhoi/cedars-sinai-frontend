...
class Day extends Component {
  render() {
    ...
    const dateCellMarkup = (
      <div
        style={{ background: `rgb(${b},${b},255)` }}
        className={`day-holder noselect ${isSelected && "day-selected"}`}
      >
        ...
        <div className="day-events-aligner">
          <div className="day-events">{eventMarkup}</div>
        </div>
      </div>
    );
